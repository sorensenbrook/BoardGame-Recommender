...
### Preparation for program: constants and imports ############################
#%%
...
###############################################################################
# Input of whole program: list of questions
###############################################################################
...
def continue_with_recommendation():
    ...
    completed_q += 1
    root.destroy()
# Should this function print something?
###############################################################################    
...
###############################################################################
# Get code that closes this loading application when recommendation is ready
###############################################################################
...
# Above code should deliver this list
###############################################################################
...
def random_game():
    df = df_filtered.drop(df_filtered[df_filtered['name'] == highest_ranked].index)
